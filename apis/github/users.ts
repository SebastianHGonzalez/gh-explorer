...
export function listUsersQuery() {
  return infiniteQueryOptions<ListUsers, Error, InfiniteData<ListUsers>, unknown[], number>({
    initialPageParam: 0,
    ...
    queryFn: async ({ pageParam }) => {
      ...
      if (pageParam) {
        searchParams.set("since", String(pageParam ?? 0));
      }
